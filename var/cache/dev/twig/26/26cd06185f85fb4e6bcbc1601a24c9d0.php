...
{% block panel %}
    ...
    {% endif %}
{% endblock %}
", "@WebProfiler/Collector/exception.html.twig", "/Users/andrejkarshakevich/Projects/guestbook/vendor/symfony/web-profiler-bundle/Resources/views/Collector/exception.html.twig");
    }
}
